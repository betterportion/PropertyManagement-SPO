...
const FEATURE_PERMISSIONS = [
  ...
  { key: "canCompleteWalkthroughs", label: "Complete Walkthroughs (resident accounts)", section: "Walkthroughs" },
  ...
  { key: "canViewBilling", label: "View Invoices", section: "Maintenance Contacts & Invoices" },
  { key: "canManageBilling", label: "Manage Invoices", section: "Maintenance Contacts & Invoices" },
  ...
  { key: "canViewFinancials", label: "View Resident Finances", section: "Resident Finances" },
  { key: "canManageFinancials", label: "Manage Resident Finances", section: "Resident Finances" },
