...
test.describe("assets — list and gallery views", () => {
  ...
  test("defaults to the list view and can switch to the gallery", async ({ page }) => {
    // List is the default; the gallery grid is not shown yet.
    ...
    // Gallery tiles appear (seeded data has assets).
  ...
  test("the fixed/movable tabs are present in both views", async ({ page }) => {
